...
import SiteManagerSidebar from './SiteManagerSidebar'
import Header from './Header'
import AppBackground from './ui/app-background'
import AIChatbot from './AIChatbot'

export default function SiteManagerLayout({ user, onLogout }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-dark-900 relative">
      ...
      <div className="relative z-10 flex w-full h-full">
        <SiteManagerSidebar user={user} onLogout={onLogout} />
